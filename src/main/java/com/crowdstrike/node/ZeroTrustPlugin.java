 ...
 * @since AM 5.5.0
 */
public class ZeroTrustPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(ZeroTrustPlugin.currentVersion,
				Collections.singletonList(ZeroTrust.class));
	}
	...
	public String getPluginVersion() {
		return ZeroTrustPlugin.currentVersion;
	}
}
